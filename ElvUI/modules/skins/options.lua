...
E.Options.args.skins = {
	...
	args = {
		...
		notes = {
            order = 11,
            type = 'group',
            name = "Nirriti's Notes",
            get = function(info) return E.global.skins.notes[ info[#info] ] end,
            set = function(info, value) E.global.skins.notes[ info[#info] ] = value; StaticPopup_Show("CONFIG_RL") end,
            args = {
                enable = {
                    name = L['Enable'],
                    type = 'toggle',
