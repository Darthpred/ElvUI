...
L["Display the hyperlink tooltip while hovering over a hyperlink."] = "Отображать подсказку ссылки при наведении на нее мыши." -- Needs review
...
L["Raid Reminder"] = "Рейдовые баффы" -- Needs review
