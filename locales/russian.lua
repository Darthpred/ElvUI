...
L["Detected either the Routes or GatherMate2 addon running, if you wish to use these addons with ElvUI you must type the /farmmode command."] = "Обнаружен запущенный аддон Routes или GatherMate2. Если Вы хотите использовать эти аддоны с ElvUI, Вы должны набрать команду /farmmode."
...
L["Minimum level of the sender to able to whisper you."] = "Минимальный уровень, которого должен достичь персонаж, чтобы отправлять вам личные сообщения."
L["Minutes"] = "Минуты"
...
L["PG"] = "Гр"
L["Physical DPS"] = "Физический урон" -- Needs review
L["PL"] = "Гр. Лидер"
L["Player"] = "Игрок"
...
L["Using the healer layout it is highly recommended you download the addon Clique to work side by side with ElvUI."] = "Для использования настроек лекаря крайне рекомендуется установка аддона Clique." -- Needs review
...
L["You may need to further alter these settings depending how low you resolution is."] = "Вам может понадобиться дальнейшее изменение этих настроек в зависимости от того, насколько низким является ваше разрешение." -- Needs review
