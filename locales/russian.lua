...
L["Change this if you want the Reminder module to check for weapon enchants, setting this will cause it to ignore any spells listed."] = "Измените этот пункт, если вы хотите, чтобы фильтр отслеживал усиления оружия. Эта установка будет игнорировать любые перечисленные заклинания." -- Needs review
...
L["Icon"] = "Иконка"
L["If any spell found inside this list is found the icon will hide as well"] = "Иконка любого заклинания в этом списке также будет скрыта" -- Needs review
...
L["Lock"] = "Закрепить"
L["LOCK_AB_ERROR"] = "Мы заметили, что у вас не заблокированы панели действий. Это может вызвать срабатывание способностей при переносе их в другой слот. Пожалуйста, выполните установку настроек по умолчанию с установке (шаг 2). Это можно сделать набрав /ес и нажав кнопку Установка."
